...
## Increment 1 – SPI & event model (design + skeleton)
...
## Increment 2 – Logging sink (baseline)
...
## Increment 3 – Traces sink (OpenTelemetry)
...
## Increment 4 – Metrics sink (Micrometer/Prometheus)
...
## Increment 5 – Pack-specific enrichment
