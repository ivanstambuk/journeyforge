...
rootProject.name = "journeyforge"
include("app")
include("journeyforge-model")

include("journeyforge-parser")

include("journeyforge-runtime-core")

include("journeyforge-connectors-http")
